...
const Login = () => {
  ...
  return (
    <div className="bg-gray-50 flex items-center justify-center p-4 sm:p-8 font-sans">
      <AuthLayout>
        <h1 className="text-3xl font-normal tracking-tight text-gray-900 mb-2">
          Welcome back{" "}
        </h1>
        <p className="text-gray-500 mb-8 text-s">
          Don't have an account?{" "}
          <Link
            to="/signup"
            className="text-[#10b981] hover:text-[#059669] hover:underline transition-color"
          >
            Sign up
          </Link>
        </p>
        ...
        <form className="space-y-4" onSubmit={handleLogIn}>
          ...
          <div className="flex items-start mt-2 ">
            <Link
              to="/forgot-password"
              className="text-[#10b981] mb-5 hover:text-[#059669] hover:underline text-sm capitalize transition-colors"
            >
              forgot password?
            </Link>
          </div>
